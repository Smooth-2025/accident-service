        ...
        stage('Build with application.yaml') {
            steps {
                script {
                    ...
                    withCredentials([file(credentialsId: 'accident-application-yml-file', variable: 'APPLICATION_YAML_FILE')]) {
        ...
        stage('Create Kubernetes Secret') {
            steps {
                script {
                    ...
                    withCredentials([
                        file(credentialsId: 'accident-application-yml-file', variable: 'SECRET_FILE_PATH'),
            ...
            script {
                ...
                withCredentials([string(credentialsId: 'discord-webhook-url', variable: 'DISCORD_WEBHOOK_URL')]) {
                    discordSend description: "Jenkins Job: ${env.JOB_NAME}",
                        ...
                        link: env.BUILD_URL,
                        title: "Accident Service Build Result",
